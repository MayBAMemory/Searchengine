...
namespace simhash
{
    ...
    class Simhasher
    {
        ...
        public:
            Simhasher(const string& dictPath = "", const string& modelPath = "", const string& userDictPath = "",const string& idfPath = "", const string& stopWords = ""): _jieba(dictPath, modelPath, userDictPath, idfPath, stopWords)
            {}
            ~Simhasher(){};
